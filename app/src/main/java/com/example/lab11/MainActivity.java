        ...
        btn_insert.setOnClickListener(view -> {
            if(ed_book.length() < 1 || ed_price.length() < 1){
                ...
                try{
                    ...
                    err.printStackTrace();
                    Toast.makeText(MainActivity.this, "新增失敗" + err.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_update.setOnClickListener(view -> {
            if(ed_book.length() < 1 || ed_price.length() < 1){
                ...
                try{
                    ...
                    err.printStackTrace();
                    Toast.makeText(MainActivity.this, "更新失敗" + err.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_delete.setOnClickListener(view -> {
            if(ed_book.length() < 1){
                ...
                try{
                    ...
                    err.printStackTrace();
                    Toast.makeText(MainActivity.this, "刪除失敗" + err.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
